      ...
      <div className="mx-auto max-w-5xl">
        ...
        >
          <p className="max-w-2xl text-sm md:text-base leading-relaxed font-light text-[#A1A1AA]">
            ...
            understanding of UI/UX principles and backend logic, I approach
            building interfaces as more than just writing code, it's about
            crafting experiences that feel intuitive and perform flawlessly. I
            thrive in the space where design meets functionality, translating
            ideas into responsive, accessible, and pixel-perfect interfaces. My
            process is driven by clean code practices, attention to detail, and
            a genuine curiosity for how every layer of a product connects.
          </p>
        </Reveal>
